...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
  ...
  <div class="row">
    ...
    <asp:Calendar ID="Calendar" runat="server" BackColor="White" 
            BorderColor="#cccccc" BorderWidth="1px" Font-Names="Verdana" Font-Size="9pt" 
        ...
        <SelectedDayStyle BackColor="#8DC63F" ForeColor="White" />
        <TitleStyle BackColor="#8DC63F" BorderColor="#cccccc" BorderWidth="1px" 
